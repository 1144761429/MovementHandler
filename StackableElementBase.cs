...
/// </summary>
public abstract class StackableElementBase
{
    protected int _stack;
    protected bool _isExclusive;
    protected bool _isFrozen;
    protected int _minStack;
    protected int _maxStack;
    protected int _defaultMinStack;
    protected int _defaultMaxStack;
    ...
    /// <summary>
    /// Constructor for StackableElement object with a initial stack of 1.
    /// </summary>
    /// <param name="isExclusive">Determines if a StackableElement can only have Stack of 1 or 0.</param>
    public StackableElementBase(bool isExclusive)
    {
        _stack = 0;
    ...
    /// <summary>
    /// Constructor for StackableElement object with a specified stack.
    /// </summary>
    /// <param name="stack">The initial Stack number.</param>
    /// <param name="isExclusive">Determines if a StackableElement can only have Stack of 1 or 0.</param>
    public StackableElementBase(int stack, bool isExclusive)
    {
